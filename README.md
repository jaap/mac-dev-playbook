...
Usefull link; [Ricbra's OSX Automation](https://blog.vandenbrand.org/2016/01/04/how-to-automate-your-mac-os-x-setup-with-ansible/)
...
## Installation
  ...
  2. Install ensible ([Ansible docs)](http://docs.ansible.com/intro_installation.html).
      1. Install pip; `sudo easy_install pip`
      2. Install Ansible via pip; `sudo pip install ansible`
